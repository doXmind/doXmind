...
# Uvicorn is pulled in for the optional `doxmind serve` localhost tooling
# command. A single CLI binary also covers browser-development service mode.
hiddenimports: list[str] = ["orjson"]
hiddenimports += collect_submodules("uvicorn")
for _pkg in ("api", "services", "core", "cli", "lib"):
