...
export const TextReviewPluginKey = new PluginKey<TextReviewPluginState>("textReview");

// Declare custom commands for TypeScript
declare module "@tiptap/core" {
  interface Commands<ReturnType> {
    textReview: {
      setReviewSuggestions: (suggestions: ReviewSuggestion[], summary?: string) => ReturnType;
...
export const TextReviewExtension = Extension.create<TextReviewExtensionOptions>({
  name: "textReview",
      ...
      new Plugin<TextReviewPluginState>({
        ...
        props: {
          decorations(state) {
            ...
            if (!pluginState?.isActive || pluginState.suggestions.length === 0) {
            ...
            for (const suggestion of pluginState.suggestions) {
              ...
              const isActive = suggestion.id === pluginState.activeSuggestionId;
